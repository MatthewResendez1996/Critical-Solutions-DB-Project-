...
<body>
	<div id="container">
		...
		<div id="main">
			...
			<h2 style="text-align:center"> Realtor </h2>
			<br>
			...
			<table>
				...
				<tr>
					<td><%= rlInfo.getRealtor_id() %></td>
					<td><%= rlInfo.getFirst_name() %></td>
					<td><%= rlInfo.getLast_name() %></td>
					<td>
					<%
					...
					<td><a href="/Debbie_Realtor/DeleteRealtor" onclick="location.href=this.href+'?id='+<%=rlInfo.getRealtor_id()%>+'&uid='+<%=usInfo.getUser_id()%>;return false;">Delete</a></td>
				</tr>
			</table></div>
