...
<body>
	<div id="container">
		...
		<div id="main">
			<div id="c1">
			<h2 style="text-align:center"> Search Contractor </h2>
			<br>
			<% Users usInfo= (Users) request.getAttribute("user_info"); %>
				<form method="POST" action="SearchContractor">
     			
					<label for="contractorid">Contractor Id:</label>
					<input type="text" name="contractor_id"><br><br>
				<br> 
				<button type="submit">Get Contractor</button>
