		...
		<div id="main">
			...
			<table>
				...
				<tr>
					...
					<td><a href="/Debbie_Realtor/SubmitBillListing" onclick="location.href=this.href+'?id='+<%= ctInfo.getContractor_id()%>+'&cid='+<%=clInfo.get(i).getContractorListingId() %>+'&lid='+<%= lsInfo.get(i).getListingId()%>+'&sid='+<%= svInfo.get(i).getServiceId()%>;return false;">Update</a></td>
				</tr>
				<%
